...
public class Pais implements java.io.Serializable {
	...
	public Pais(int id, Continentes continentes, String nombre, int poblacion) {
		this.id = id;
	...
	public Pais(int id, Continentes continentes, String nombre, int poblacion, String jefeEstado) {
		this.id = id;
		this.continentes = continentes;
		this.nombre = nombre;
		this.poblacion = poblacion;
